...
export const DEFAULT_WORK_MODES = {
  coding: {
    id: 'coding',
    name: 'Coding 模式',
    description: 'Full-cycle software engineering: planning, implementation, testing, debugging, review, and delivery. Skills are orchestrated per task scenario with recursive analysis and verification at each step.',
    builtin: true,
    editable: true,
    defaultSkillIds: [
      // 规划
