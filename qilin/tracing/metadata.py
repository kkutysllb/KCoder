...
def build_langfuse_trace_metadata(
    *,
    ...
    Args:
        ...
        qilin_trace_id: Optional QiLin request trace id; falls back to
    ...
    request_trace_id = normalize_trace_id(qilin_trace_id) or get_current_trace_id()
    if request_trace_id:
        metadata[QILIN_TRACE_METADATA_KEY] = request_trace_id
