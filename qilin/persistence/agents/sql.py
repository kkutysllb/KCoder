...
and uses its own small engine (see :mod:`qilin.persistence.agents.base` for
...
from qilin.config.agents_config import AgentConfig
...
class SqlAgentStore(AgentStore):
    ...
    def delete(self, name: str, *, user_id: str | None = None) -> AgentDeleteOutcome:
        ...
        if row_deleted:
            ...
            # (qilinmem file backend) so it is not orphaned. Mirrors the file
