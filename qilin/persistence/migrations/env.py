"""Alembic environment for QiLin application tables.

ONLY manages QiLin's tables (runs, threads_meta, feedback, users,
...
from qilin.persistence.migrations._env_filters import (
...
try:
    ...
    logging.getLogger(__name__).warning("Could not import qilin.persistence.models; Alembic may not detect all tables")
...
async def run_migrations_online() -> None:
    ...
    # ``qilin.persistence.engine`` sets this on its own connections, but
