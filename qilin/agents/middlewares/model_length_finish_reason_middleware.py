...
Background — see issue bytedance/qilin#4271.
...
content. QiLin should preserve that content for audit, but it should not
...
from qilin.agents.middlewares.model_length_termination_detectors import (
