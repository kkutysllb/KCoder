...
Background — see issues bytedance/qilin#3028 (truncated tool calls) and
...
from qilin.agents.middlewares.safety_termination_detectors import (
    SafetyTermination,
    SafetyTerminationDetector,
    default_detectors,
)
from qilin.agents.middlewares.tool_call_metadata import clone_ai_message_with_tool_calls
from qilin.runtime.events.catalog import MIDDLEWARE_SAFETY_TERMINATION_TAG
from qilin.utils.custom_events import aemit_custom_event, emit_custom_event
