...
async def task_tool(
    ...
    qilin_trace_id = normalize_trace_id(parent_context.get(QILIN_TRACE_METADATA_KEY)) or normalize_trace_id(metadata.get(QILIN_TRACE_METADATA_KEY)) or get_current_trace_id()
