...
id: git-worktrees
name: Git Worktrees
description: "Use git worktree to run parallel work in separate directories sharing one repository, instead of stashing or switching in a single checkout."
---
# Git Worktrees Skill
