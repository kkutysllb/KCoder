"""Summarization middleware extensions for QiLin."""
...
class QiLinSummarizationMiddleware(SummarizationMiddleware):
...
def create_summarization_middleware(
    *,
    ...
    run_model_name: str | None = None,
) -> QiLinSummarizationMiddleware | None:
    ...
    if resolved_app_config.memory.enabled and not skip_memory_flush:
        from qilin.agents.memory.summarization_hook import memory_flush_hook

        hooks.append(memory_flush_hook)

    return QiLinSummarizationMiddleware(
        **kwargs,
