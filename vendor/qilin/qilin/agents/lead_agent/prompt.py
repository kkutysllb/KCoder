...
# ``_user_scoped_storages`` in ``qilin.skills.storage``; the
...
def _start_enabled_skills_refresh_thread() -> None:
    threading.Thread(
        ...
        name="qilin-enabled-skills-loader",
        daemon=True,
    ).start()
...
is user-managed data (visible and editable via the QiLin UI) — you may
...
QiLin is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/bytedance/qilin). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:QiLin Documentation](https://qilin.dev/docs).
...
### Primary Sources
- [GitHub Repository](https://github.com/bytedance/qilin) - Official source code and documentation
- [QiLin Documentation](https://qilin.dev/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/bytedance/qilin) - 官方源代码和文档`
...
"""
        ...
        from qilin.agents.memory import MemoryManagerError
...
def get_skills_prompt_section(
    ...
    *,
    ...
    if skill_names is not None:
        from qilin.skills.describe import get_skill_index_prompt_section
