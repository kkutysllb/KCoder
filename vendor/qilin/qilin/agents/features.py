"""Declarative feature flags and middleware positioning for create_qilin_agent.
...
class RuntimeFeatures:
    """Declarative feature flags for ``create_qilin_agent``.
    ...
    # Explicit memory config for direct create_qilin_agent(features=...) callers.
