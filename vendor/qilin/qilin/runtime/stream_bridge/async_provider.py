...
Usage (e.g. FastAPI lifespan)::
    ...
    from qilin.agents.stream_bridge import make_stream_bridge
...
_ENV_REDIS_URL = "QILIN_STREAM_BRIDGE_REDIS_URL"
...
async def make_stream_bridge(app_config: AppConfig | None = None) -> AsyncIterator[StreamBridge]:
    ...
    if config is None or config.type == "memory":
        from qilin.runtime.stream_bridge.memory import MemoryStreamBridge
    ...
    if config.type == "redis":
        from qilin.runtime.stream_bridge.redis import RedisStreamBridge
