...
from qilin.agents.thread_state import SandboxStateField, ThreadDataState
from qilin.runtime.user_context import resolve_runtime_user_id
from qilin.sandbox import get_sandbox_provider
...
class SandboxMiddleware(AgentMiddleware[SandboxMiddlewareState]):
    ...
    #
    # Background:
    #   ``ensure_sandbox_initialized*`` in ``qilin.sandbox.tools`` mutates
