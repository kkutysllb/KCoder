"""Pure view-state reducer for the QiLin TUI.
...
The runtime bridge (``qilin.tui.runtime``) is responsible for translating
``QiLinClient`` ``StreamEvent`` objects into these actions; the Textual app
