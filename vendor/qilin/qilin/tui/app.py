...
pure renderers. Agent runs execute on a worker *thread* (``QiLinClient.stream``
...
class QiLinTUI(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield ComposerInput(placeholder="Message QiLin…   ( / for commands )", id="composer")
