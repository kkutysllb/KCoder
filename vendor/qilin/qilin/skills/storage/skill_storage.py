...
class SkillStorage(ABC):
    ...
    def validate_skill_markdown_content(name: str, content: str) -> None:
        ...
        from qilin.skills.validation import _validate_skill_frontmatter
    ...
    def get_skills_root_path(self) -> Path:
        ...
        Origin: ``qilin.skills.loader.get_skills_root_path``.
        """
    ...
    def _iter_skill_files(self) -> Iterable[tuple[SkillCategory, Path, Path]]:
        ...
        ``qilin.skills.loader.load_skills``.
        """
    ...
    def read_custom_skill(self, name: str) -> str:
        ...
        Origin: ``qilin.skills.manager.read_custom_skill_content``.
        """
    ...
    def write_custom_skill(self, name: str, relative_path: str, content: str) -> None:
        ...
        Origin: ``qilin.skills.manager.atomic_write``.
        """
    ...
    def custom_skill_exists(self, name: str) -> bool:
        """Origin: ``qilin.skills.manager.custom_skill_exists``."""

    @abstractmethod
    def public_skill_exists(self, name: str) -> bool:
        """Origin: ``qilin.skills.manager.public_skill_exists``."""

    @abstractmethod
    def append_history(self, name: str, record: dict) -> None:
        """Append a JSONL history entry for ``name``.

        Origin: ``qilin.skills.manager.append_history``.
        """
    ...
    def read_history(self, name: str) -> list[dict]:
        ...
        Origin: ``qilin.skills.manager.read_history``.
        """
    ...
    def get_custom_skill_file(self, name: str) -> Path:
        ...
        Origin: ``qilin.skills.manager.get_custom_skill_file``.
        """
        normalized_name = self.validate_skill_name(name)
    ...
    def get_skill_history_file(self, name: str) -> Path:
        ...
        **incorrect** for :class:`UserScopedSkillStorage`. Subclasses that
        ...
        Origin: ``qilin.skills.manager.get_skill_history_file``.
        """
        normalized_name = self.validate_skill_name(name)
    ...
    def load_skills(self, *, enabled_only: bool = False) -> list[Skill]:
        ...
        Origin: ``qilin.skills.loader.load_skills``.
        """
    ...
    def ensure_custom_skill_is_editable(self, name: str) -> None:
        """Origin: ``qilin.skills.manager.ensure_custom_skill_is_editable``.
