"""``E2BSandboxProvider`` — QiLin :class:`SandboxProvider` for e2b cloud.
...
.. code-block:: yaml
    ...
    sandbox:
      use: qilin.community.e2b_sandbox:E2BSandboxProvider
...
from qilin.sandbox.exceptions import SandboxCapacityExceededError
...
META_KEY_USER = "qilin_user"
META_KEY_THREAD = "qilin_thread"
META_KEY_PROVIDER = "qilin_provider"
META_KEY_GATEWAY = "qilin_gateway"
META_KEY_CREATED_AT = "qilin_created_at"
...
class E2BSandboxProvider(SandboxProvider):
    ...
    def __init__(self) -> None:
        ...
        # Active sandboxes, keyed by QiLin-side sandbox id (== e2b id).
    ...
    def _create_sandbox(self, thread_id: str | None, *, user_id: str) -> str:
        ...
        # Materialise QiLin's virtual path layout (/mnt/user-data/...) inside
    ...
    def _bootstrap_sandbox_paths(self, client: E2BClientSandbox) -> None:
        """Materialise QiLin's virtual path layout inside the e2b VM.
    ...
    def _sync_outputs_to_host(
        ...
        *,
        ...
        QiLin's ``/api/threads/{tid}/artifacts/...`` endpoint resolves
        ...
        """
        from qilin.config.paths import get_paths  # lazy import to avoid cycles
