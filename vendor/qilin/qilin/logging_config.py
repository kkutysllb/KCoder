"""Logging setup helpers for QiLin."""
...
from qilin.config.app_config import apply_logging_level
...
_TRACE_FILTER_NAME = "qilin_trace_context_filter"
...
def configure_logging(config: object) -> None:
    """Configure QiLin logging from an AppConfig-like object.
    ...
    for handler in logging.root.handlers:
        if enhanced:
            ...
            if getattr(handler.formatter, "_qilin_trace_formatter", False):
