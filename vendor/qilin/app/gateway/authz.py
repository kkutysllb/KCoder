"""Authorization decorators and context for QiLin.
...
from qilin.config.authorization_config import AuthorizationConfig
...
def require_auth[**P, T](func: Callable[P, T]) -> Callable[P, T]:
    ...
    async def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        if getattr(request, "_qilin_test_bypass_auth", False):
