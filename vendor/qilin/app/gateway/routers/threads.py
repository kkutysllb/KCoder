...
:func:`qilin.runtime.serialization.serialize_channel_values` to
...
from qilin.runtime.journal import build_branch_history_seed_events
from qilin.runtime.runs.manager import ConflictError
from qilin.runtime.runs.worker import valid_duration_entry
...
_SIDECAR_METADATA_KEY = "qilin_sidecar"
_BRANCH_METADATA_KEY = "qilin_branch"
...
class ThreadSearchRequest(BaseModel):
    ...
    def _validate_metadata_filters(cls, v: dict[str, Any]) -> dict[str, Any]:
        ...
        See ``qilin.persistence.json_compat`` for the shared validators.
        """
        if not v:
            return v
