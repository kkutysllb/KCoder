	...
	factory: (require) => {
		...
		*  open and file tabs default closed. */
		...
		function EditorHost(props) {
			...
			*/
			...
			(0, react.useEffect)(() => {
				let cancelled = false;
				setKcodercGitHint(null);
				setKcodercDiffOpen(false);
				if (path === "") return;
				const kcodercRelOf = (absolute) => {
					const base = (scope.cwd ?? "").replace(/[\\/]+$/, "");
					return base !== "" && absolute.startsWith(base + "/") ? absolute.slice(base.length + 1) : absolute;
				};
				const kcodercRel = kcodercRelOf(path);
				(async () => {
					try {
						const kcodercStatus = await api.gitStatus(scope);
						if (cancelled || kcodercStatus.isRepo !== true) return;
						const kcodercEntry = (kcodercStatus.entries ?? []).find((candidate) => candidate.path === kcodercRel);
						if (kcodercEntry === void 0) return;
						if (kcodercEntry.xy === "??") {
							const kcodercText = await api.fsRead(scope, kcodercEntry.path);
							if (cancelled || kcodercText.kind !== "text") return;
							setKcodercGitHint({ add: kcodercCountLines(kcodercText.content), del: 0, diffText: "", untracked: true, untrackedContent: kcodercText.content, path: kcodercEntry.path });
							return;
						}
						const kcodercUnstaged = kcodercEntry.xy[1] !== void 0 && kcodercEntry.xy[1] !== " " && kcodercEntry.xy[1] !== "?";
						let kcodercUseStaged = !kcodercUnstaged;
						let kcodercResult = await api.gitDiff(scope, kcodercEntry.path, kcodercUseStaged);
						if (cancelled) return;
						if (kcodercResult.diff === "") {
							const kcodercOther = await api.gitDiff(scope, kcodercEntry.path, !kcodercUseStaged);
							if (cancelled) return;
							if (kcodercOther.diff !== "") { kcodercResult = kcodercOther; kcodercUseStaged = !kcodercUseStaged; }
						}
						if (cancelled) return;
						const kcodercCounts = kcodercCountDiff(kcodercResult.diff);
						if (kcodercCounts.add + kcodercCounts.del === 0) return;
						setKcodercGitHint({ add: kcodercCounts.add, del: kcodercCounts.del, diffText: kcodercResult.diff, untracked: false, untrackedContent: void 0, path: kcodercEntry.path });
					} catch {}
				})();
				return () => {
					cancelled = true;
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(EditorPathInput, {
							...
							cwd: scope.cwd,
							onOpen: openFile
						}, path), kcodercGitHint !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							style: {
								flex: "none",
								display: "inline-flex",
								...
								background: kcodercDiffOpen ? "var(--dsw-alias-interactive-bg-active)" : "transparent",
								border: "1px solid var(--dsw-alias-border-l2)",
								borderRadius: "999px",
								padding: "1px 8px",
								cursor: "pointer"
							},
							title: kcodercGitHint.path,
							onClick: () => {
								setKcodercDiffOpen((value) => !value);
							},
							children: ["Diff", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "var(--dsw-alias-state-success-primary)" },
								children: ["+", kcodercGitHint.add]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "var(--dsw-alias-state-error-primary)" },
								children: ["−", kcodercGitHint.del]
							})]
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						!showEmpty && kcodercDiffOpen && kcodercGitHint !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								position: "absolute",
								inset: "0",
								zIndex: 5,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: { font: "var(--dsw-font-xxxs-strong-11)", color: "var(--dsw-alias-label-secondary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: "1", minWidth: "0" },
											children: kcodercGitHint.path
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											style: { flex: "none", font: "var(--dsw-font-xxxs-11)", color: "var(--dsw-alias-brand-primary)", background: "transparent", border: "none", cursor: "pointer", padding: "2px 6px" },
											onClick: () => {
												setKcodercDiffOpen(false);
											},
											children: t("diffCollapse")
										})]
									}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: { flex: "1", minHeight: "0", overflow: "auto" },
									children: kcodercGitHint.untracked === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DiffView, {
										diff: "",
										untrackedPath: kcodercGitHint.path,
										untrackedContent: kcodercGitHint.untrackedContent ?? ""
									}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DiffView, { diff: kcodercGitHint.diffText })
								})
							]
						}),
						]
		...
		*  floods the panel at once (the end of the log is reached by paging). */
		...
		function GitView(props) {
			...
			const refresh = (0, react.useCallback)(async () => {
				...
				setError(null);
				try {
					const [statusResult, branchResult, logResult, kcodercUnstaged, kcodercStaged] = await Promise.all([
						api.gitStatus(scope),
						...
						api.gitDiff(scope).catch(() => ({ diff: "" })),
						api.gitDiff(scope, void 0, true).catch(() => ({ diff: "" }))
					]);
					setStatus(statusResult);
					setKcodercStatTotal(kcodercCountDiff(kcodercUnstaged.diff, kcodercStaged.diff));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
						...
						}), kcodercStatTotal !== null && kcodercStatTotal.add + kcodercStatTotal.del > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							style: {
								display: "inline-flex",
								alignItems: "center",
								gap: "6px",
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "var(--dsw-alias-state-success-primary)" },
								children: ["+", kcodercStatTotal.add]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "var(--dsw-alias-state-error-primary)" },
								children: ["−", kcodercStatTotal.del]
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: sidebar_module_css_default.iconButton,
		...
		*/
		...
		function kcodercCountDiff(...texts) {
			let add = 0;
			let del = 0;
			for (const text of texts) for (const file of parseUnifiedDiff(text).files) {
