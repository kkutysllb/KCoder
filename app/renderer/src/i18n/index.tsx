...
const zhCN: Dict = {
  ...
  'settings.skills.tab.workspace': '工作区与个人',
  'settings.skills.tab.plugin': 'Plugin',
  'settings.skills.tab.marketplace': '技能市场',
  'settings.skills.market.install': '安装',
  'settings.skills.market.installing': '安装中...',
  'settings.skills.market.allInstalled': '市场中的技能均已安装',
  ...
  'settings.skills.badge.invalid': '无效',
  'settings.skills.delete': '删除技能',
  'settings.skills.detail.version': '版本',
  'settings.skills.detail.category': '类别',
  'settings.skills.detail.status': '状态',
  'settings.skills.detail.commands': '命令',
  'settings.skills.detail.permissions': '权限',
...
const en: Dict = {
  ...
  'settings.skills.tab.workspace': 'Workspace & Personal',
  'settings.skills.tab.plugin': 'Plugin',
  'settings.skills.tab.marketplace': 'Marketplace',
  'settings.skills.market.install': 'Install',
  'settings.skills.market.installing': 'Installing...',
  'settings.skills.market.allInstalled': 'All marketplace skills are installed',
  ...
  'settings.skills.badge.invalid': 'Invalid',
  'settings.skills.delete': 'Delete skill',
  'settings.skills.detail.version': 'Version',
  'settings.skills.detail.category': 'Category',
  'settings.skills.detail.status': 'Status',
  'settings.skills.detail.commands': 'Commands',
  'settings.skills.detail.permissions': 'Permissions',
