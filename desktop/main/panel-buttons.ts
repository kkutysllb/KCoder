 ...
 * （终端 dsh-terminal client 注入 right:44px、上下文 context-button
 * 注入 right:76px、本地编辑器 open-in-app-button 注入 right:108px）
 * 挂在自绘标题栏内——absolute 定位基于包含块 padding box（≈窗口右缘），
 ...
 *   随「平铺让位」决策废弃。
 * - 现行平铺：三钮不隐藏，仅以样式表 !important 把 right 整体平移
 *   +138px（182/214/246，原生区左侧安全位）——样式表 !important
